...
$(document).ready(function() {
  ...
  $("body").on("change", ".input-number", function() {
    ...
    if (valueCurrent >= minValue) {
      $plusMinus.find(".btn-number[data-type='minus']").removeAttr("disabled");
  ...
  $(".site-nav__sub-arrow").click(function(e) {
    e.stopPropagation();
    e.preventDefault();
    $(this).toggleClass("site-nav__sub-arrow--open");
  ...
  function compulsoryCheck() {
    var result = true;
    var txt = "";
    $(".calc-sidebar .calculator__cat[data-compulsory=1]").each(function(k, v) {
  ...
  $(".js-add-to-cart").click(addToCart);
  ...
  $(".site-elements__tab button").click(function(e) {
    e.preventDefault();
    ...
    $($this.data("tab")).addClass("product__tab-content--visible");
  ...
  function addItem(pid, pname, price, pricec, cid) {
  ...
  $(".calculator__main").on("click", ".calc-product__add-to-cart", function(e) {
    e.preventDefault();
    ...
    var price = $(".calc-product__price span", $container).data("price");
    var pricec = $(".calc-product__price span", $container).text();
    var cid = $input.data("cid");
    $container.addClass("calc-product--added");

    addItem(pid, pname, price, pricec, cid);

    updatePrice();
  });

  $(
    ".catalog__main, .search__main"
  ).on("click", ".calc-product__add-to-cart", function(e) {
    e.preventDefault();
  ...
  $(
    ".catalog__main, .search__main"
  ).on("click", ".calc-product__remove-from-cart", function(e) {
    e.preventDefault();
  ...
  $(
    ...
    if (
      $item.closest(".calculator__cat").find(".calc-sidebar__product").length <=
      1
    ) {
